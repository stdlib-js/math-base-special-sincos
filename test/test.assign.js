...
tape( 'the function supports providing an output typed array', function test( t ) {
	...
	t.equal( parts[ 0 ], 0.8414709848078965, 'has expected first element' );
	t.equal( parts[ 1 ], 0.5403023058681398, 'has expected second element' );
...
tape( 'the function supports specifying a stride', function test( t ) {
	...
	t.equal( val[ 0 ], 0.8414709848078965, 'returns expected value' );
	t.equal( val[ 1 ], 0, 'returns expected value' );
	t.equal( val[ 2 ], 0.5403023058681398, 'returns expected value' );
...
tape( 'the function supports specifying an offset', function test( t ) {
	...
	t.equal( val[ 1 ], 0.8414709848078965, 'returns expected value' );
	t.equal( val[ 2 ], 0, 'returns expected value' );
	t.equal( val[ 3 ], 0.5403023058681398, 'returns expected value' );
