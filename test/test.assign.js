...
tape( 'the function returns `NaN` if provided a `NaN`', function test( t ) {
	...
	z = [ 0.0, 0.0 ];
	v = sincos( NaN, z, 1, 0 );
	t.strictEqual( v, z, 'returns output array' );
...
tape( 'the function supports providing an output typed array', function test( t ) {
	...
	parts = sincos( 1.0, out, 1, 0 );

	t.strictEqual( parts, out, 'returns output array' );
	t.strictEqual( parts[ 0 ], 0.8414709848078965, 'has expected first element' );
	t.strictEqual( parts[ 1 ], 0.5403023058681398, 'has expected second element' );
...
tape( 'the function supports specifying a stride', function test( t ) {
	...
	val = sincos( 1.0, out, 2, 0 );

	t.strictEqual( val, out, 'returns output array' );
	t.strictEqual( val[ 0 ], 0.8414709848078965, 'returns expected value' );
	t.strictEqual( val[ 1 ], 0, 'returns expected value' );
	t.strictEqual( val[ 2 ], 0.5403023058681398, 'returns expected value' );
...
tape( 'the function supports specifying an offset', function test( t ) {
	...
	out = new Float64Array( 4 );
	val = sincos( 1.0, out, 2, 1 );

	t.strictEqual( val, out, 'returns output array' );
	t.strictEqual( val[ 0 ], 0, 'returns expected value' );
	t.strictEqual( val[ 1 ], 0.8414709848078965, 'returns expected value' );
	t.strictEqual( val[ 2 ], 0, 'returns expected value' );
	t.strictEqual( val[ 3 ], 0.5403023058681398, 'returns expected value' );
