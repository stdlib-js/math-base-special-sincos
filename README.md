...
```javascript
import sincos from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-sincos@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-sincos@v0.2.1-esm/index.mjs';
```
